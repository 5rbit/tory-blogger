...
def test_competition_and_intent_raise_score():
    base = K(keyword="등산화", volume=1000, competition=0.3, personal_ratio=0.5)
    comp = K(keyword="등산화", volume=1000, competition=0.9, personal_ratio=0.5)
    intent = K(keyword="등산화 추천", volume=1000, competition=0.3, personal_ratio=0.5)
    w = ["추천"]
