...
아래 규칙을 반드시 지키세요.
- 첫 줄은 '# ⛰️ 제목' (산 이름 앞에 ⛰️, 30자 이내, 키워드 앞쪽)
...
- 코스 글에는 거리·소요시간·난이도·주차·대중교통 표, 네이버 지도 링크 자리, 하산 후 식당 표(네이버 지역 검색 기준, 추천처럼 단정하지 않음)
...
- 이모지를 적극 쓴다: 소제목 앞 1개(🥾🍁📍🗺️🎒🍲🚌⚠️📌), 난이도는 🥾 개수(1~5)+이름(산책 수준/가볍게/땀 좀 나요/빡센 편/극한 도전), '난이도' 라벨에는 💪, 날씨 ☀️⛅☁️🌧️❄️, 단풍 🍁, 정상 ⛰️, 출발 🚩, 하산 🏁. 문장 안에는 문단당 1개 이하
- 마지막 줄에 해시태그 정확히 7개
